...
public interface Logger {
   ...
   * level. However, this variant incurs the hidden (and relatively small) cost of creating an
   * <code>Object[]</code> before invoking the method, even if this logger is disabled for INFO.
   *
   * @param format the format string
   * @param arguments a list of 3 or more arguments
   */
   ...
   * level. However, this variant incurs the hidden (and relatively small) cost of creating an
   * <code>Object[]</code> before invoking the method, even if this logger is disabled for WARN.
   *
   * @param format the format string
   * @param arguments a list of 3 or more arguments
   */
