...
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
  ...
  private static String DataTypeClause(Options options) {
  ...
  private ResultSet getImportedKeys(
    ...
    DataType[] dataTypes = {
      ...
      DataType.NULL, DataType.SMALLINT
    };
    ...
    for (String part : parts) {
      ...
      for (int i = 0; i < primaryKeyCols.size(); i++) {
        ...
        row[12] = null;
        row[13] = Integer.toString(java.sql.DatabaseMetaData.importedKeyNotDeferrable);
        data.add(row);
      }
    }
    ...
    return CompleteResult.createResultSet(
        columnNames, dataTypes, arr, connection.getContext().getExceptionFactory());
  }
  ...
  private String dataTypeClause(String fullTypeColumnName) {
    Options options = conf.getOptions();
  ...
  public ResultSet getTypeInfo() {
    ...
    return CompleteResult.createResultSet(
        columnNames, dataTypes, data, connection.getContext().getExceptionFactory());
  }
  ...
  public ResultSet getClientInfoProperties() {
    ...
    DataType[] types =
        new DataType[] {DataType.STRING, DataType.INTEGER, DataType.STRING, DataType.STRING};
    String[][] data =
        new String[][] {
          new String[] {
            "ApplicationName",
    ...
    return CompleteResult.createResultSet(
        columnNames, types, data, connection.getContext().getExceptionFactory());
  }
